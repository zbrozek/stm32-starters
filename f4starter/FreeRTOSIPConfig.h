...
to a pre-determinable value. */
	...
	#define ipconfigNUM_RX_DESCRIPTORS 6
    #define ipconfigNUM_TX_DESCRIPTORS 10
    #define ipconfigNUM_NETWORK_BUFFER_DESCRIPTORS		( ipconfigNUM_TX_DESCRIPTORS + ipconfigNUM_RX_DESCRIPTORS )
#else
